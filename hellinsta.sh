...
printf "\e[1;77m\e[41m  Running as: hellinsta (for ethical academic research)  \e[0m\n"
printf "\n"
}
...
# (resume functions also updated with found.hellinsta, omitted for brevity here but should match above changes...)
